...
<head>
	<!-- Required meta tags -->
	<meta charset="utf-8">
	<meta name="添加新的单选题" content="width=device-width, initial-scale=1, shrink-to-fit=no">
...
if (isset($_POST['textd']))
     ...
     $nameError="部分选项未填写";{
			$str2 = "select count(*) from onechoice";
			$result2 = mysqli_query($con, $str2);
			$pass2 = mysqli_fetch_row($result2);
			$pa2 = $pass2[0] + 1;
if (isset($_SESSION['bankid']))
{
$sql_query = "update banks set onechoice=CONCAT(onechoice,'" . $pa2 . ",')WHERE bid='". $_SESSION['bankid'] . "'";
$con->query($sql_query);
...
$nameError="未指定题库，或直接刷新此界面";
			{				
$sql_query = "insert into onechoice values(" . $pa2 . ",'" . $text . "','" . $choices ."','".$_POST['answer'] .  "',0,0,0,0)";
