...
#$password = "lsf79239265"; /* Password */

#$dbname = "tutorial"; /* Database name */

$password = "changke0328"; /* Password */

$dbname = "banks"; /* Database name */
                            ...
                            <div class="col-sm-5 mt-sm-0 mt-4">
                                ...
                                <div >
                                    ...
                                    <form method='post' action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
                                        ...
                                        <h4><button style="font-size:15px" type="submit" value=1 name="set_current">1</button></h4>
                            ...
                            <div class="col-sm-5 mt-sm-0 mt-4">
                                ...
                                <div class="features14-para">
                                    ...
                                    <form method='post' action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
                                        ...
                                        <h4><button style="font-size:15px" type="submit" value=2 name="set_current">2</button></h4>
                                ...
                                <div class="col-sm-5 mt-sm-0 mt-4">
                                    ...
                                    <div class="features14-para">
                                        ...
                                        <form method='post' action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
                                            ...
                                            <h4><button style="font-size:15px" type="submit" value=<?php $tmp=$current-1;echo $tmp?> name="set_current"><?php $tmp=$current-1;echo $tmp?></button></h4>
                                ...
                                <div class="col-sm-5 mt-sm-0 mt-4">
                                    ...
                                    <div class="features14-para">
                                        ...
                                        <form method='post' action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
                                            ...
                                            <h4><button style="font-size:15px" type="submit" value=<?php echo $current?> name="set_current"><?php echo $current?></button></h4>
                            ...
                            <div class="col-sm-5 mt-sm-0 mt-4">
                                ...
                                <div class="features14-para">
                                    ...
                                    <form method='post' action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
                                        ...
                                        <h4><button style="font-size:15px" type="submit" value=<?php $tmp=$pages-1;echo $tmp ?> name="set_current"><?php $tmp=$pages-1;echo $tmp ?></button></h4>
                            ...
                            <div class="col-sm-5 mt-sm-0 mt-4">
                                ...
                                <div class="features14-para">
                                    ...
                                    <form method='post' action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
                                        ...
                                        <h4><button style="font-size:15px" type="submit" value=<?php echo $pages ?> name="set_current"><?php echo $pages ?></button></h4>
                                    ...
                                    <div class="col-sm-5 mt-sm-0 mt-4">
                                        ...
                                        <div class="features14-para">
                                            ...
                                            <form method='post' action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
                                                ...
                                                <h4><button style="font-size:15px" type="submit" value=<?php echo$i?> name="set_current"><?php echo $i?></button></h4>
